...
const Navbar = () => {
  ...
  return (
    <div className='bg-white w-full h-16 flex justify-between px-[30px] border-b-[1px] items-center font-poppins fixed top-0 left-0 right-0 z-20'>
      <div className='text-subheading font-semibold'>Dine<span className='text-primary'>Flow</span></div>
      ...
      <div className='h-[40px] w-[40px] rounded-full border-[1px] max-md:hidden relative'> 
        <img src={avatar} alt="" />
      </div>
