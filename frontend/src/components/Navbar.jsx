...
const Navbar = () => {
  ...
  return (
    <div className='bg-white w-full h-16 flex justify-between px-[30px] border-b-[1px] items-center font-poppins fixed top-0 left-0 right-0 z-20'>
      {/* <div className='text-subheading font-semibold'>Buddy's <span className='text-primary'>Kitchen</span></div> */}
      ...
      <div className='h-[40px] w-[40px] rounded-full border-[1px] max-md:hidden relative hover:cursor-pointer' onClick={() => {role=='user'&&Navigate('/layout/user/profilepage')}}> 
        <img src={avatar} alt="" />
      </div>
